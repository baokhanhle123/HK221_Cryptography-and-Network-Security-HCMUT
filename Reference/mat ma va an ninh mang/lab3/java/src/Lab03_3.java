...
public class Lab03_3 {
	...
	static private void encryptDES(String fileName, String DESKeyFileName)
		...
		// Create a Secret key
		byte key[] = readFile(DESKeyFileName).getBytes();///lay noi dung key 
...
//		//Verify
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Nhap 1 de ky va ma hoa, 2 de giai ma va xac thuc, 3 de tao cap khoa");
		int choice = cin.nextInt();
		cin.nextLine();
		if (choice == 1) {
			System.out.println("Nhap ten file can ky va ma hoa");
			String fileName = cin.nextLine();
			System.out.println("Nhap ten file private key");
			String pvtKeyFile = cin.nextLine();
			System.out.println("Nhap ten file DES key");
			String DESKeyFile = cin.nextLine();
			signAndEncrypt(fileName, pvtKeyFile, DESKeyFile);
			
		}
		else if (choice == 2) {
			System.out.println("Nhap ten file can giai ma va xac thuc");
			String fileName = cin.nextLine();
			System.out.println("Nhap ten file chu ky da ma hoa");
