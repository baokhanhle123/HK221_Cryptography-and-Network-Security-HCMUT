...
public class RSA
{	
	public static byte[] toBytes(String data, int length) throws UnsupportedEncodingException {
	    byte[] result = new byte[length];
	    System.arraycopy(data.getBytes("UTF-8"), 0, result, length - data.length(), data.length());
	    return result;
	}
	...
	byte[] signStr2 = Base64.getDecoder().decode(str);
	
	System.out.println("Message: " + message);
	System.out.println("Sign: " + str);
	System.out.println("Sign byte long: " + signStr);
	System.out.println("Sign byte 2 long: " + signStr2);
	
	//Verify
	boolean result = verifySignature(message.getBytes(), signStr2, pubKeyFile);
