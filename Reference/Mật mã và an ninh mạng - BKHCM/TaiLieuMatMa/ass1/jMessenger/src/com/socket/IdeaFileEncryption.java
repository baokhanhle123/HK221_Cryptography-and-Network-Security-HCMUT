...
public static class BlockStreamCrypter {
    Idea            idea;
    boolean         encrypt;
    Mode            mode;
...
public static void pumpData(FileChannel inChannel, long inDataLen, FileChannel outChannel, long outDataLen, BlockStreamCrypter bsc) throws IOException {
...
public static long readDataLength (FileChannel channel, BlockStreamCrypter bsc) throws IOException {
...
public static void writeDataLength (FileChannel channel, long dataLength, BlockStreamCrypter bsc) throws IOException {
...
public static byte[] packDataLength (long i) {
...
public static long unpackDataLength (byte[] b) {
...
public static void xor (byte[] a, int pos, byte[] b) {
