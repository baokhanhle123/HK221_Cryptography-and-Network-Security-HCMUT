            ...
            try {
                ...
                if(msg.type.equals("message")){
                    if(msg.recipient.equals(ui.username)){
                        ...
                        msg.key1 = des.DESStringDecrypt(msg.key1);
                        msg.key2 = des.DESStringDecrypt(msg.key2);
                        rsa mm = new rsa();
                        BigInteger d = new BigInteger(msg.key1, 10);
                        BigInteger n = new BigInteger(msg.key2, 10);
                        msg.content = mm.decrypt(msg.content, d, n);
