...
import com.socket.DESEncryption2;
import com.socket.IdeaFileEncryption;
import static com.socket.IdeaFileEncryption.Mode.ECB;
import com.socket.MD5Checksum;
...
public class ChatFrame extends javax.swing.JFrame {
    ...
    public ChatFrame() {
        initComponents();
        this.setTitle("Sercurity Message");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int bitlen = 1024;
        rsa mm = new rsa(bitlen);
        msg = mm.encrypt(msg);
        jLabel8.setText(msg);
        if(!msg.isEmpty() && !target.isEmpty()){
            jTextField4.setText("");
            DESEncryption2 des = new DESEncryption2();
            String d = des.DESStringEncrypt(mm.d.toString());
            String n = des.DESStringEncrypt(mm.n.toString());
            client.send(new Message("message", username, msg, target, d, n));
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
            ...
            if(size < 120 * 1024 * 1024){
                ...
                try {
                    m.cryptFile(file.getPath(), "./encryptfile/" + file.getName(), "keythuha", true, ECB);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        int select = fc.showDialog(this, "Choose File");
        File selectedFile = fc.getSelectedFile();
        MD5Checksum  md5 = new MD5Checksum();
        if (select == JFileChooser.APPROVE_OPTION) {
            String MD5 = md5.fileToMD5Convert(selectedFile);
            System.out.print(MD5);
            jTextArea1.append(MD5 +"\n");
        }else{
